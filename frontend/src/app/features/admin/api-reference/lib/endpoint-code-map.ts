...
export const ENDPOINT_CODE_MAP: Record<string, EndpointCodeDependency> = {
  'auth-register': {
    ...
    frontend: [
      { file: 'frontend/src/app/services/auth.service.ts', line: 32, detail: 'API client call: authApi.register()' },
  ...
  'auth-login': {
    ...
    frontend: [
      { file: 'frontend/src/app/services/auth.service.ts', line: 35, detail: 'API client call: authApi.login()' },
  ...
  'profile-get': {
    ...
    frontend: [
      { file: 'frontend/src/app/services/user.service.ts', line: 16, detail: 'API client call: userApi.getProfile()' },
    ],
  },
  'profile-put': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/user.service.ts', line: 19, detail: 'API client call: userApi.updateProfile()' },
  ...
  'exams-post': {
    ...
    frontend: [
      { file: 'frontend/src/app/services/exam.service.ts', line: 49, detail: 'API client call: examApi.create()' },
  ...
  'exams-get': {
    ...
    frontend: [
      { file: 'frontend/src/app/services/exam.service.ts', line: 52, detail: 'API client call: examApi.getAll()' },
    ],
  },
  'exams-get-id': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/exam.service.ts', line: 55, detail: 'API client call: examApi.getById()' },
    ],
  },
  'results-submit': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/result.service.ts', line: 33, detail: 'API client call: resultApi.submit()' },
  ...
  'results-student': {
    ...
    frontend: [
      { file: 'frontend/src/app/services/result.service.ts', line: 36, detail: 'API client call: resultApi.getByStudent()' },
    ],
  },
  'admin-exams': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/admin.service.ts', line: 94, detail: 'API client call: adminApi.getExams()' },
    ],
  },
  'admin-results': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/admin.service.ts', line: 102, detail: 'API client call: adminApi.getResults()' },
    ],
  },
  'reports-performance': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/report.service.ts', line: 82, detail: 'API client call: reportApi.getExamPerformance()' },
    ],
  },
  'reports-passfail': {
    backend: [
    ...
    frontend: [
      { file: 'frontend/src/app/services/report.service.ts', line: 85, detail: 'API client call: reportApi.getPassFail()' },
    ],
  },
};
