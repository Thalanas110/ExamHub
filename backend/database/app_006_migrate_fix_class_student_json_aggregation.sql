-- Migration: Fix class student aggregation to avoid GROUP_CONCAT truncation.
-- This updates class/data procedures to use JSON_ARRAYAGG so large classes
-- return valid studentIds payloads.
